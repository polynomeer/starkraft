...
class SnapshotStreamConsumerTest {
    ...
    fun `summarizes snapshot stream records`() {
        val summary =
            summarizeSnapshotStream(
                sequenceOf(
                    ...
                    "{\"recordType\":\"harvesterRetarget\",\"sequence\":10,\"tick\":0,\"events\":[{\"workerId\":14,\"fromNodeId\":10,\"toNodeId\":9,\"resourceKind\":\"minerals\"},{\"workerId\":14,\"fromNodeId\":9,\"toNodeId\":11,\"resourceKind\":\"minerals\"}]}",
                    "{\"recordType\":\"harvestCycle\",\"sequence\":11,\"tick\":0,\"events\":[{\"kind\":\"pickup\",\"workerId\":13,\"nodeId\":9,\"dropoffId\":1,\"resourceKind\":\"minerals\",\"amount\":2},{\"kind\":\"deposit\",\"workerId\":13,\"nodeId\":9,\"dropoffId\":1,\"resourceKind\":\"minerals\",\"amount\":2}]}",
                    "{\"recordType\":\"production\",\"sequence\":12,\"tick\":0,\"events\":[{\"kind\":\"enqueue\",\"buildingId\":1,\"typeId\":\"Marine\",\"remainingTicks\":75,\"spawnedEntityId\":null},{\"kind\":\"progress\",\"buildingId\":1,\"typeId\":\"Marine\",\"remainingTicks\":74,\"spawnedEntityId\":null},{\"kind\":\"complete\",\"buildingId\":1,\"typeId\":\"Marine\",\"remainingTicks\":0,\"spawnedEntityId\":9},{\"kind\":\"cancel\",\"buildingId\":1,\"typeId\":\"Marine\",\"remainingTicks\":40,\"spawnedEntityId\":null}]}",
                    "{\"recordType\":\"metrics\",\"sequence\":13,\"tick\":1,\"factions\":[{\"faction\":1,\"alive\":5,\"visibleTiles\":20,\"minerals\":150,\"gas\":25},{\"faction\":2,\"alive\":4,\"visibleTiles\":18,\"minerals\":80,\"gas\":10}],\"pathRequests\":3,\"pathSolved\":2,\"pathQueueSize\":7,\"avgPathLength\":6.5,\"replans\":2,\"replansBlocked\":1,\"replansStuck\":1}",
                    "{\"recordType\":\"pathAssigned\",\"sequence\":14,\"tick\":1,\"entities\":[{\"entityId\":7,\"pathLength\":9,\"goalX\":28,\"goalY\":28},{\"entityId\":8,\"pathLength\":6,\"goalX\":12,\"goalY\":10}]}",
                    "{\"recordType\":\"pathProgress\",\"sequence\":15,\"tick\":1,\"entities\":[{\"entityId\":7,\"waypointIndex\":3,\"remainingNodes\":5,\"completed\":false},{\"entityId\":8,\"waypointIndex\":6,\"remainingNodes\":0,\"completed\":true}]}",
                    "{\"recordType\":\"vision\",\"sequence\":16,\"tick\":1,\"changes\":[{\"faction\":1,\"x\":8,\"y\":8,\"visible\":true},{\"faction\":2,\"x\":12,\"y\":12,\"visible\":false}]}",
        ...
        assertEquals(22, summary.totalRecords)
            ...
            renderSnapshotStreamSummary(
                ...
                summarizeSnapshotStream(
                    sequenceOf(
                        ...
                        "{\"recordType\":\"harvesterRetarget\",\"sequence\":10,\"tick\":0,\"events\":[{\"workerId\":13,\"fromNodeId\":10,\"toNodeId\":9,\"resourceKind\":\"minerals\"}]}",
                        "{\"recordType\":\"harvestCycle\",\"sequence\":11,\"tick\":0,\"events\":[{\"kind\":\"pickup\",\"workerId\":13,\"nodeId\":9,\"dropoffId\":1,\"resourceKind\":\"minerals\",\"amount\":3},{\"kind\":\"deposit\",\"workerId\":13,\"nodeId\":9,\"dropoffId\":1,\"resourceKind\":\"minerals\",\"amount\":3}]}",
                        "{\"recordType\":\"production\",\"sequence\":12,\"tick\":0,\"events\":[{\"kind\":\"enqueue\",\"buildingId\":1,\"typeId\":\"Marine\",\"remainingTicks\":75,\"spawnedEntityId\":null}]}",
                        "{\"recordType\":\"metrics\",\"sequence\":13,\"tick\":1,\"factions\":[],\"pathRequests\":3,\"pathSolved\":2,\"pathQueueSize\":7,\"avgPathLength\":6.5,\"replans\":2,\"replansBlocked\":1,\"replansStuck\":1}",
                        "{\"recordType\":\"pathAssigned\",\"sequence\":14,\"tick\":1,\"entities\":[{\"entityId\":7,\"pathLength\":9,\"goalX\":28,\"goalY\":28}]}",
                        "{\"recordType\":\"pathProgress\",\"sequence\":15,\"tick\":1,\"entities\":[{\"entityId\":8,\"waypointIndex\":6,\"remainingNodes\":0,\"completed\":true}]}",
                        "{\"recordType\":\"vision\",\"sequence\":16,\"tick\":1,\"changes\":[{\"faction\":1,\"x\":8,\"y\":8,\"visible\":true},{\"faction\":2,\"x\":12,\"y\":12,\"visible\":false}]}",
