...
class GraphicalClientTest {
    ...
    fun `locates command button by panel click`() {
        ...
        val clear = commandButtonAt(width = 640, x = 640 - 150, y = 82 + (32 * 34), catalog = testCatalog, statusLineCount = 2, hasSelection = true, canTrain = true, canResearch = true)
