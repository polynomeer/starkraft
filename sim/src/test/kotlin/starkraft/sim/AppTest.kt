...
class AppTest {
    ...
    fun `cli arg validator rejects unknown options and missing values`() {
        ...
        val missingByFlagValue =
            assertThrows(IllegalStateException::class.java) {
                validateCliArgs(arrayOf("--script", "--noSleep"))
            }
        assertTrue(missingByFlagValue.message!!.contains("Missing value"))
    ...
    @Test
    fun `cli semantic validator rejects replay validate only conflicts`() {
        val metaConflict =
            assertThrows(IllegalStateException::class.java) {
                validateCliSemantics(
                    replayPath = "a.replay",
        ...
        assertTrue(metaConflict.message!!.contains("cannot be combined"))
    ...
    @Test
    fun `cli semantic validator keeps replay stats modes report-only`() {
        val ticksConflict =
            assertThrows(IllegalStateException::class.java) {
                validateCliSemantics(
                    replayPath = "a.replay",
