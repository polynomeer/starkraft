    ...
    fun `renders tick summary stream record json`() {
        val json =
            renderTickSummaryStreamRecordJson(
                ...
                researchCompleted = 0,
                researchFailures = 1,
                researchFailureReasons = ResearchFailureCounts(0, 0, 1, 0, 0, 0, 0, 0),
                mineralsSpent = 50,
                gasSpent = 5,
                mineralsRefunded = 10,
                gasRefunded = 0,
    ...
    fun `renders session stats stream record json`() {
        val json =
            renderSessionStatsStreamRecordJson(
                ...
                researchCompleted = 4,
                researchFailures = 3,
                researchFailureReasons = ResearchFailureCounts(0, 1, 0, 1, 0, 0, 1, 0),
                mineralsSpent = 450,
                gasSpent = 25,
                mineralsRefunded = 50,
                gasRefunded = 0,
