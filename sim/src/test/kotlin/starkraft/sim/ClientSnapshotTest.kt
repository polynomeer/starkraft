...
class ClientSnapshotTest {
    ...
    fun `renders producer state stream record json`() {
        val json =
            renderProducerStateStreamRecordJson(
                ...
                entities =
                    listOf(
                        ProducerStateEntityRecord(41, 1, "Depot", "producer", true, true, 4, 2f, 1f),
                        ProducerStateEntityRecord(42, 2, "Barracks", "producer", true, false, 5, 0f, 0f)
                    ),
                pretty = false
            )

        assertEquals(
            "{\"recordType\":\"producerState\",\"sequence\":14,\"tick\":5,\"entities\":[{\"entityId\":41,\"faction\":1,\"typeId\":\"Depot\",\"archetype\":\"producer\",\"supportsTraining\":true,\"supportsRally\":true,\"productionQueueLimit\":4,\"defaultRallyOffsetX\":2.0,\"defaultRallyOffsetY\":1.0},{\"entityId\":42,\"faction\":2,\"typeId\":\"Barracks\",\"archetype\":\"producer\",\"supportsTraining\":true,\"supportsRally\":false,\"productionQueueLimit\":5,\"defaultRallyOffsetX\":0.0,\"defaultRallyOffsetY\":0.0}]}",
            json
        )
    }
    ...
    fun `renders session stats stream record json`() {
        ...
        assertEquals(
            "{\"recordType\":\"sessionStats\",\"sequence\":24,\"ticks\":1500,\"pathRequests\":120,\"pathSolved\":110,\"replans\":30,\"replansBlocked\":12,\"replansStuck\":5,\"attacks\":80,\"kills\":14,\"despawns\":14,\"builds\":3,\"buildFailures\":1,\"buildFailureReasons\":{\"invalidDefinition\":0,\"invalidFootprint\":0,\"invalidPlacement\":1,\"insufficientResources\":0},\"trainsQueued\":8,\"trainsCompleted\":6,\"trainsCancelled\":1,\"trainFailures\":2,\"trainFailureReasons\":{\"missingBuilding\":0,\"invalidUnit\":0,\"invalidBuildTime\":0,\"incompatibleProducer\":1,\"insufficientResources\":0,\"queueFull\":1,\"nothingToCancel\":0},\"mineralsSpent\":450,\"gasSpent\":25,\"mineralsRefunded\":50,\"gasRefunded\":0,\"mineralsSpentFaction1\":300,\"mineralsSpentFaction2\":150,\"gasSpentFaction1\":25,\"gasSpentFaction2\":0,\"mineralsRefundedFaction1\":50,\"mineralsRefundedFaction2\":0,\"gasRefundedFaction1\":0,\"gasRefundedFaction2\":0,\"finalVisibleTilesFaction1\":220,\"finalVisibleTilesFaction2\":198,\"finalMineralsFaction1\":350,\"finalMineralsFaction2\":500,\"finalGasFaction1\":25,\"finalGasFaction2\":10,\"finalWorldHash\":123456789,\"finalReplayHash\":987654321}",
            json
        )
    }
