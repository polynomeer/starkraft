    ...
    fun `renders tick summary stream record json`() {
        val json =
            renderTickSummaryStreamRecordJson(
                ...
                trainsCancelled = 0,
                trainFailures = 1,
                trainFailureReasons = TrainFailureCounts(0, 0, 0, 0, 0, 0, 0, 1, 0),
                researchQueueBuildings = 1,
                researchQueued = 1,
                researchCancelled = 1,
                researchCompleted = 0,
                researchFailures = 1,
                researchFailureReasons = ResearchFailureCounts(0, 0, 1, 0, 0, 0, 0, 0, 1),
                mineralsSpent = 50,
                gasSpent = 5,
                mineralsRefunded = 10,
                gasRefunded = 0,
    ...
    fun `renders session stats stream record json`() {
        val json =
            renderSessionStatsStreamRecordJson(
                ...
                trainsCancelled = 1,
                trainFailures = 2,
                trainFailureReasons = TrainFailureCounts(0, 0, 0, 0, 0, 1, 0, 1, 0),
                researchQueueBuildings = 1,
                researchQueued = 5,
                researchCancelled = 2,
                researchCompleted = 4,
                researchFailures = 3,
                researchFailureReasons = ResearchFailureCounts(0, 1, 0, 1, 0, 0, 1, 0, 1),
                mineralsSpent = 450,
                gasSpent = 25,
                mineralsRefunded = 50,
                gasRefunded = 0,
        ...
        assertEquals(
            "{\"recordType\":\"sessionStats\",\"sequence\":24,\"ticks\":1500,\"pathRequests\":120,\"pathSolved\":110,\"replans\":30,\"replansBlocked\":12,\"replansStuck\":5,\"attacks\":80,\"kills\":14,\"despawns\":14,\"builds\":3,\"buildsCancelled\":2,\"buildFailures\":1,\"buildFailureReasons\":{\"invalidDefinition\":0,\"missingTech\":0,\"invalidFootprint\":0,\"invalidPlacement\":1,\"insufficientResources\":0},\"trainsQueued\":8,\"trainsCompleted\":6,\"trainsCancelled\":1,\"trainFailures\":2,\"trainFailureReasons\":{\"missingBuilding\":0,\"underConstruction\":0,\"missingTech\":0,\"invalidUnit\":0,\"invalidBuildTime\":0,\"incompatibleProducer\":1,\"insufficientResources\":0,\"queueFull\":1,\"nothingToCancel\":0},\"researchQueueBuildings\":1,\"researchQueued\":5,\"researchCancelled\":2,\"researchCompleted\":4,\"researchFailures\":3,\"researchFailureReasons\":{\"missingBuilding\":0,\"underConstruction\":1,\"invalidTech\":0,\"missingTech\":1,\"incompatibleProducer\":0,\"insufficientResources\":0,\"alreadyUnlocked\":1,\"queueFull\":0,\"nothingToCancel\":1},\"mineralsSpent\":450,\"gasSpent\":25,\"mineralsRefunded\":50,\"gasRefunded\":0,\"mineralsSpentFaction1\":300,\"mineralsSpentFaction2\":150,\"gasSpentFaction1\":25,\"gasSpentFaction2\":0,\"mineralsRefundedFaction1\":50,\"mineralsRefundedFaction2\":0,\"gasRefundedFaction1\":0,\"gasRefundedFaction2\":0,\"harvestedMinerals\":220,\"harvestedGas\":18,\"harvestedMineralsFaction1\":140,\"harvestedMineralsFaction2\":80,\"harvestedGasFaction1\":12,\"harvestedGasFaction2\":6,\"harvestPickupCount\":120,\"harvestDepositCount\":118,\"harvestPickupAmount\":238,\"harvestDepositAmount\":231,\"harvesterRetargets\":9,\"dropoffBuildingsFaction1\":2,\"dropoffBuildingsFaction2\":1,\"mineralDropoffBuildings\":2,\"gasDropoffBuildings\":1,\"depletedNodes\":4,\"changedResourceNodes\":39,\"finalVisibleTilesFaction1\":220,\"finalVisibleTilesFaction2\":198,\"finalMineralsFaction1\":350,\"finalMineralsFaction2\":500,\"finalGasFaction1\":25,\"finalGasFaction2\":10,\"finalWorldHash\":123456789,\"finalReplayHash\":987654321}",
            json
        )
    }
