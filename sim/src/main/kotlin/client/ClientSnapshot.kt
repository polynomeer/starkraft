...
data class EntitySnapshot(
    ...
    val pathGoalX: Int? = null,
    val pathGoalY: Int? = null,
...
@Serializable
data class ResourceDeltaEventRecord(
    val faction: Int,
    val kind: String,
    val minerals: Int,
    val gas: Int
...
@Serializable
data class ResourceDeltaStreamRecord(
    val recordType: String = "resourceDelta",
    val sequence: Long,
    val tick: Int,
    val events: List<ResourceDeltaEventRecord>
)
...
data class TickSummaryStreamRecord(
    ...
    val mineralsFaction1: Int,
    val mineralsFaction2: Int,
    val gasFaction1: Int,
    val gasFaction2: Int,
    val pathRequests: Int,
    val pathSolved: Int,
    ...
    val harvestedMineralsFaction1: Int,
    val harvestedMineralsFaction2: Int,
    val harvestedGasFaction1: Int,
    val harvestedGasFaction2: Int,
    val harvestPickupCount: Int,
    val harvestDepositCount: Int,
    val harvestPickupAmount: Int,
    val harvestDepositAmount: Int,
    val harvesterRetargets: Int,
...
@Serializable
data class ResearchFailureCounts(
    val missingBuilding: Int,
    val underConstruction: Int,
    val invalidTech: Int,
    val missingTech: Int,
...
@Serializable
data class RallyStreamRecord(
    val recordType: String = "rally",
    val sequence: Long,
    val tick: Int,
    val buildingId: Int,
    val x: Float,
...
@Serializable
data class RallyFailureStreamRecord(
    val recordType: String = "rallyFailure",
    val sequence: Long,
    val tick: Int,
...
@Serializable
data class ProducerFailureStreamRecord(
    val recordType: String = "producerFailure",
    val sequence: Long,
    val tick: Int,
    val buildingId: Int? = null,
...
@Serializable
data class BuildFailureStreamRecord(
    val recordType: String = "buildFailure",
    val sequence: Long,
    val tick: Int,
    val faction: Int,
    val typeId: String,
...
data class SessionStatsStreamRecord(
    ...
    val finalMineralsFaction2: Int,
    val finalGasFaction1: Int,
    val finalGasFaction2: Int,
    ...
    for (id in ids) {
        ...
        entities.add(
            EntitySnapshot(
                ...
                pathGoalX = path?.goalX?.takeIf { it >= 0 },
                pathGoalY = path?.goalY?.takeIf { it >= 0 },
...
fun renderResourceDeltaStreamRecordJson(
    sequence: Long,
    tick: Int,
    events: List<ResourceDeltaEventRecord>,
    pretty: Boolean = false
): String {
...
fun renderTickSummaryStreamRecordJson(
    ...
    mineralsFaction1: Int,
    mineralsFaction2: Int,
    gasFaction1: Int,
    gasFaction2: Int,
    pathRequests: Int,
    pathSolved: Int,
    ...
    harvestedGas: Int,
    harvestedMineralsFaction1: Int,
    harvestedMineralsFaction2: Int,
    harvestedGasFaction1: Int,
    harvestedGasFaction2: Int,
    harvestPickupCount: Int,
    harvestDepositCount: Int,
    harvestPickupAmount: Int,
    harvestDepositAmount: Int,
    harvesterRetargets: Int,
    ...
    val record =
        TickSummaryStreamRecord(
            ...
            mineralsFaction1 = mineralsFaction1,
            mineralsFaction2 = mineralsFaction2,
            gasFaction1 = gasFaction1,
            gasFaction2 = gasFaction2,
            pathRequests = pathRequests,
            pathSolved = pathSolved,
            pathQueueSize = pathQueueSize,
            avgPathLength = avgPathLength,
            ...
            harvestedMineralsFaction1 = harvestedMineralsFaction1,
            harvestedMineralsFaction2 = harvestedMineralsFaction2,
            harvestedGasFaction1 = harvestedGasFaction1,
            harvestedGasFaction2 = harvestedGasFaction2,
            harvestPickupCount = harvestPickupCount,
            harvestDepositCount = harvestDepositCount,
            harvestPickupAmount = harvestPickupAmount,
            harvestDepositAmount = harvestDepositAmount,
            harvesterRetargets = harvesterRetargets,
...
fun renderRallyStreamRecordJson(
    sequence: Long,
    tick: Int,
    buildingId: Int,
    x: Float,
    ...
    val record = RallyStreamRecord(sequence = sequence, tick = tick, buildingId = buildingId, x = x, y = y)
    return if (pretty) snapshotJsonPretty.encodeToString(record) else snapshotJsonCompact.encodeToString(record)
}

fun renderRallyFailureStreamRecordJson(
    sequence: Long,
    tick: Int,
    reason: String,
    buildingId: Int? = null,
    ...
    val record = RallyFailureStreamRecord(sequence = sequence, tick = tick, buildingId = buildingId, reason = reason)
    return if (pretty) snapshotJsonPretty.encodeToString(record) else snapshotJsonCompact.encodeToString(record)
}

fun renderProducerFailureStreamRecordJson(
    sequence: Long,
    tick: Int,
    reason: String,
    buildingId: Int? = null,
...
fun renderBuildFailureStreamRecordJson(
    sequence: Long,
    tick: Int,
    faction: Int,
    typeId: String,
...
fun renderSessionStatsStreamRecordJson(
    ...
    finalMineralsFaction2: Int,
    finalGasFaction1: Int,
    finalGasFaction2: Int,
    finalWorldHash: Long,
    ...
    val record =
        SessionStatsStreamRecord(
            ...
            finalMineralsFaction2 = finalMineralsFaction2,
            finalGasFaction1 = finalGasFaction1,
            finalGasFaction2 = finalGasFaction2,
