...
internal class GdxWorldRenderer(
    ...
    private val fogColor = Color(0.04f, 0.08f, 0.10f, 0.42f)
    private val shroudColor = Color(0.02f, 0.04f, 0.06f, 0.64f)
    private val minimapFogColor = Color(0.03f, 0.06f, 0.08f, 0.34f)
    private val minimapShroudColor = Color(0.02f, 0.04f, 0.05f, 0.54f)
