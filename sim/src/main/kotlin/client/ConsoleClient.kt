...
internal fun renderClientTextFrame(state: ClientSessionState): String {
    ...
    val selectionClassSummary = buildSelectionClassSummary(snapshot, state.selectedIds)
    val selectionPositionSummary = buildSelectionPositionSummary(snapshot, state.selectedIds)
    val selectionDensitySummary = buildSelectionDensitySummary(snapshot, state.selectedIds)
    val selectionVisibilitySummary = buildSelectionVisibilitySummary(snapshot, state)
    val selectionHealthSummary = buildSelectionHealthSummary(snapshot, state.selectedIds)
    ...
    val selectionPathSummary = buildSelectionPathSummary(snapshot, state.selectedIds)
    val selectionOrderSummary = buildSelectionOrderSummary(snapshot, state.selectedIds)
    val selectionIdleSummary = buildSelectionIdleSummary(snapshot, state.selectedIds)
    val selectionPhaseSummary = buildSelectionPhaseSummary(snapshot, state.selectedIds)
    ...
    val selectionAlertSummary = buildSelectionAlertSummary(snapshot, state.selectedIds)
    ...
    val selectionEtaSummary = buildSelectionEtaSummary(snapshot, state.selectedIds)
    ...
    return buildString {
        ...
        append(" ")
        append(selectionClassSummary)
        append(" ")
        append(selectionPositionSummary)
        append(" ")
        append(selectionDensitySummary)
        append(" ")
        append(selectionVisibilitySummary)
        append(" ")
        append(selectionHealthSummary)
        append(" ")
        ...
        append(" ")
        append(selectionPathSummary)
        append(" ")
        append(selectionOrderSummary)
        append(" ")
        append(selectionIdleSummary)
        append(" ")
        append(selectionPhaseSummary)
        append(" ")
