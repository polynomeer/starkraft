...
internal fun renderClientTextFrame(state: ClientSessionState): String {
    ...
    val taskSummary = buildTaskSummary(snapshot, state.selectedIds)
    val pathSummary = buildPathSummary(snapshot, state.selectedIds)
    val fogSummary = buildFogSummary(snapshot, state.visionState, state.viewedFaction)
