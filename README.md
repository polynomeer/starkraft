...
- Example consumer:
  ...
  This reads the NDJSON stream and prints record counts plus session/hash metadata, including economy, producer/production, combat, and pathing summaries when present.
