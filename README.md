...
The graphical and console clients also show the latest tick-level build/research outcome pressure, e.g. `activity: builds=1/x1 buildFails=2 research=q1/c0/x1 researchFails=1 @15`.
